---
name: security-audit
description: Comprehensive security analysis covering common vulnerability patterns, dependency risks, and configuration weaknesses. Use when the user asks for a security audit, runs /security-audit, or wants OWASP Top 10, dependency CVE, secret-exposure, auth, or config-weakness scanning of this codebase.
---
